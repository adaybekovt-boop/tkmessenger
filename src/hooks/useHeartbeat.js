...
export function useHeartbeat({ connsRef, peerIdRef, peersRef, getConn, upsertPeer, sendEncryptedEphemeral }) {
  ...
  }, [connsRef, getConn, peerIdRef, peersRef, sendEncryptedEphemeral, upsertPeer]);
