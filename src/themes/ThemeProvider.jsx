...
export function ThemeProvider({ children }) {
  ...
  // Toggle a marker class so CSS can strip opaque page backgrounds when
  // an atmospheric theme renders its own full-screen background layer.
  useEffect(() => {
    document.documentElement.classList.toggle('orb-atmospheric', !!BackgroundComponent);
    return () => document.documentElement.classList.remove('orb-atmospheric');
  }, [BackgroundComponent]);
