                    ...
                    <div className="flex items-center gap-3">
                      {auth.user?.avatarDataUrl ? (
                        ...
                        <div className="grid h-12 w-12 place-items-center rounded-2xl bg-[rgb(var(--orb-bg-rgb))]/45 text-sm font-semibold text-[rgb(var(--orb-text-rgb))] ring-1 ring-[rgb(var(--orb-border-rgb))]">
                          {(auth.user?.displayName || auth.user?.nickname || 'O').charAt(0).toUpperCase()}
                        </div>
                      )}
                      <div className="min-w-0">
                        <div className="truncate text-sm font-semibold text-[rgb(var(--orb-text-rgb))]">{auth.user?.displayName || auth.user?.nickname}</div>
                        <div className="truncate text-xs text-[rgb(var(--orb-muted-rgb))]">@{auth.user?.nickname}</div>
                      </div>
                    </div>
                  </Row>
