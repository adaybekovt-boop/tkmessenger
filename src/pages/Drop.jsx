...
export default function Drop() {
  ...
  useEffect(() => {
    ...
    return () => dropRef.current.deactivate();
  }, []);
            ...
            {selectedPeer && (
              ...
              >
                ...
                <button
                  ...
                  onClick={handleSend}
                  className={cx(
                    'flex w-full items-center justify-center gap-2 rounded-2xl px-4 py-3 text-sm font-medium transition-all duration-200 active:scale-[0.98]',
                    selectedFiles.length > 0
                      ? 'bg-[rgb(var(--orb-accent-rgb))] text-white'
                      : 'bg-[rgb(var(--orb-surface-rgb))]/30 text-[rgb(var(--orb-muted-rgb))]'
                  )}
                >
