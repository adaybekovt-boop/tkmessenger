...
function MessageBubble({ msg, mine, showSeconds, onContextMenu }) {
  ...
  return (
    ...
    >
      {isSticker ? (
        ...
        <div
          className={cx('max-w-[92%] rounded-3xl px-4 py-3 text-sm text-[rgb(var(--orb-text-rgb))] select-text', bubbleBase)}
          onContextMenu={handleContextMenu}
          onPointerDown={handlePointerDown}
          onPointerUp={cancelLongPress}
          onPointerLeave={cancelLongPress}
