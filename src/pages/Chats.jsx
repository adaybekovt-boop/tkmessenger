    ...
    <div className="rounded-2xl bg-[rgb(var(--orb-surface-rgb))]/40 p-3">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="inline-flex h-10 shrink-0 items-center gap-2 rounded-xl bg-[rgb(var(--orb-accent-rgb))] px-3 text-sm font-medium text-white transition-colors duration-200 active:scale-95 sm:px-4"
        >
          <UserPlus2 className="h-4 w-4 shrink-0" />
          <span className="hidden sm:inline whitespace-nowrap">Добавить</span>
        </button>
      </div>
  ...
  return (
    <div className="orb-page-bg flex h-full w-full overflow-hidden">
      ...
      >
        ...
        <div ref={scrollRef} className="orb-scroll flex-1 overflow-y-auto px-4 py-5">
        ...
        {mobileListOpen ? (
          ...
          >
            <motion.div
              ...
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between border-b border-[rgb(var(--orb-border-rgb))]/50 bg-[rgb(var(--orb-bg-rgb))] px-4 py-3">
                <button
                  type="button"
                  onClick={() => setMobileListOpen(false)}
                  className="inline-flex h-9 w-9 items-center justify-center rounded-xl text-[rgb(var(--orb-muted-rgb))] transition-colors duration-200 hover:text-[rgb(var(--orb-text-rgb))]"
                  aria-label="Назад"
                >
                  <ChevronLeft className="h-5 w-5" />
                </button>
                <div className="text-sm font-medium text-[rgb(var(--orb-text-rgb))]">Контакты</div>
                <button
                  type="button"
                  onClick={() => setMobileListOpen(false)}
                  className="inline-flex h-9 w-9 items-center justify-center rounded-xl text-[rgb(var(--orb-muted-rgb))] transition-colors duration-200 hover:text-[rgb(var(--orb-text-rgb))]"
