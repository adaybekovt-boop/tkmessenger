    ...
    <PeerProvider>
      ...
      >
        ...
        <main
          ...
          style={{ height: 'calc((var(--orb-vvh, 1vh) * 100) - 56px - var(--orb-nav-h, 78px))' }}
        >
        ...
        <nav
          className="orb-nav-bar orb-blur flex h-[78px] items-center gap-2 overflow-hidden border-t border-[rgb(var(--orb-border-rgb))] bg-[rgb(var(--orb-bg-rgb))]/70 px-3 pb-[max(12px,env(safe-area-inset-bottom))] pt-3"
          role="navigation"
