...
import { Download, Loader2, MessageSquare, Radar, Send, Settings2, X } from 'lucide-react';
...
const RadarView = lazy(() => import('./pages/Radar.jsx'));
    ...
    <PeerProvider>
      ...
      >
        ...
        >
          ...
          <TabButton active={tab === 'radar'} icon={Radar} label="Радар" onClick={() => { hapticTap(); setTab('radar'); }} />
