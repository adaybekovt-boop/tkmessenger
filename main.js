...
async function openSettingsPanel() {
    if (!settingsModal) return;
    console.log('Settings: openSettingsPanel()');
...
if (openSettingsBtn) {
    openSettingsBtn.addEventListener(
        ...
        (e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log('Settings button clicked (sidebar gear)');
...
if (bottomSettingsBtn) {
    bottomSettingsBtn.addEventListener(
        'click',
        (e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log('Settings button clicked (bottom nav)');
            void openSettingsPanel();
        },
        { passive: false }
    );
...
if (bottomChatsBtn) {
    bottomChatsBtn.addEventListener(
        'click',
        (e) => {
            e.preventDefault();
            e.stopPropagation();
...
if (bottomContactsBtn) {
    bottomContactsBtn.addEventListener(
        'click',
        (e) => {
            e.preventDefault();
            e.stopPropagation();
    ...
    settingsModal.addEventListener(
        ...
        (e) => {
            if (e.target === settingsModal) {
                console.log('Settings: backdrop click — close');
                closeSettingsPanel();
            }
        },
        { passive: true }
